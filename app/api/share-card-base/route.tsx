    ...
    (
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px", textAlign: "center" }}>
          <div style={{ color: "#d946ef", letterSpacing: "12px", fontSize: 28, fontWeight: 700 }}>
            MAWER ORACLE
          </div>
          <div style={{ fontSize: 82, fontWeight: 700, lineHeight: 1.1 }}>{card}</div>
          <div style={{ fontSize: 36, color: "#888" }}>{original}</div>
        </div>

        <div style={{ height: "860px" }} />

        <div style={{
          border: "1px solid rgba(217,70,239,0.35)", borderRadius: 48, padding: 48,
          display: "flex", flexDirection: "column", gap: 36, background: "#111"
        }}>
          <div style={{ color: "#d946ef", fontSize: 28, letterSpacing: "8px", fontWeight: 700 }}>
            {rarity}
          </div>
